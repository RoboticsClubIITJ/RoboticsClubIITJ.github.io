...
const MemberCard = ({ member, index, highlight = false }: { member: any, index: number, highlight?: boolean }) => {
  return (
    <motion.div
      ...
      className={`p-6 rounded-2xl border bg-white/3 backdrop-blur-sm transition-all duration-300 ${highlight
    ...
    >
      <div className="flex items-start gap-5">
        <div className={`w-16 h-16 rounded-full border overflow-hidden flex items-center justify-center flex-shrink-0 ${highlight
  ...
  return (
    <div className="relative min-h-screen pt-24 pb-24 overflow-x-hidden">
      ...
      <div className="relative z-10 max-w-6xl mx-auto px-4 sm:px-6">
        ...
        <div className="mb-20">
          <h2 className="text-2xl font-bold text-white mb-8">Club Coordinators</h2>
        ...
        {/* Mentors Section */}
        <div className="mb-20">
          <h2 className="text-2xl font-bold text-white mb-8">Mentors</h2>
